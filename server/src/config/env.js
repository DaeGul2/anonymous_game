...
const env = {
  ...
  HOST_ACTION_SECONDS: num("HOST_ACTION_SECONDS", 60),

  ROUND_END_TIMEOUT_SECONDS: num("ROUND_END_TIMEOUT_SECONDS", 180),

  REVEAL_CARD_SECONDS: num("REVEAL_CARD_SECONDS", 30),
  REVEAL_VIEW_PER_PLAYER: num("REVEAL_VIEW_PER_PLAYER", 15),
  REVEAL_VIEW_MAX_SECONDS: num("REVEAL_VIEW_MAX_SECONDS", 60),
